		...
		if (element.isJsonArray()) {
			...
			if (versionDifference == -1) { // Outdated
				MinecraftVersion.getLogger().log(Level.WARNING,
						"The NBT-API located at '" + NBTItem.class.getPackage() + "' seems to be outdated!");
				MinecraftVersion.getLogger().log(Level.WARNING, "Current Version of NBT-API: '" + MinecraftVersion.VERSION
				...
				MinecraftVersion.getLogger().log(Level.WARNING,
						"Please let G_K_ know NBT-API is outdated so no future NBT-API errors can occur!");
